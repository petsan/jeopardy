...
function clueClickManager(event) {
  ...
  questionDisplayDiv.textContent = objectReference.question;
  table.append(questionDisplayDiv);
  // stopped here. next step is to display the buttons to indicate team correct/incorrect, which changes scores
}
